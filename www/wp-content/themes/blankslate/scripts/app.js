    ...
    */
    ...
    ApplicationView.prototype.render = function() {
      ...
      return $.ajax({
        ...
        success: function(e) {
          console.log(e);
          return $("#view-container").html("Successfully received recent posts; view browser console for output.");
        },
        error: function(e) {
          console.log(e);
          return $("#view-container").html("Error: " + e);
        }
      });
    };
...
(this.require.define({
  "models/ApplicationModel": function(exports, require, module) {
...
(function() {
  ...
  exports.ApplicationModel = (function(_super) {

    __extends(ApplicationModel, _super);

    function ApplicationModel() {
      ApplicationModel.__super__.constructor.apply(this, arguments);
    }
    ...
    */
    ...
    ApplicationModel.prototype.defaults = null;
